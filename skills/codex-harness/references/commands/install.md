...
질문 5: "추가 게이트를 활성화하시겠습니까?"
  ...
  options:
    ...
    - label: "+ AI Security (격리된 보안 분석)"
      description: "코딩 에이전트와 완전히 분리된 별도 Codex 프로세스로 취약점 탐지. 확증 편향 없음. critical/high 발견 시 커밋 차단. Codex-compatible isolated security runner 필요."
